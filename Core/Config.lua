...
local generalOptionsGroup =  {
    ...
    args = {
--       qualityFilter = {
--            type = "select", order = 20, name = "Quality Filter", desc = "Items below the selected quality will not show in the loot collected list",  values = LA.CONST.QUALITY_FILTER,
--            set = function(info, value)
...
--            end,
--        },
        --spacer = { type = "description", order = 25, name = " ", width = "half", },
...
--------------------------------------------------------------------------		
        autoStartLA = {
            type = "toggle", order = 55, name = "Auto-start without prompting |cff00ff00NEW!|r",  desc = "Enabling this will auto-start LootAppraiser instead of prompting upon first loot.", width = "double",
            set = function (info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
...
--------------------------------------------------------------------------
		...
		autoRepairGear = {
			type = "toggle", order = 63, name = "Auto Repair Gear", desc = "Auto repair gear using your currency.", width = "double", 			--added 9.24.2019
			set = function (info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
		...
		autoDestroyTrash = {
			type = "toggle", order = 64, name = "Auto Destroy Gray Items", desc = "Automatically destroys gray items from bags on each loot to save bag space.", width = "double", 	--added 9.24.2019	
			set = function (info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
                    LA:Print("Auto Destroy Gray Items: " .. Config.FormatBoolean(value) .. ".")
                end
                LA.db.profile.general[info[#info]] = value;
            end,
        },	
            ...
            args = {
                    ...
                    args = {
                        displayMainUiOptions = { type = "group", order = 10, name = "Main UI", hidden = false, inline = true,
                            args = {
								...
								showValueSoldToVendor =  { type = "toggle", order = 73, name = "Show Gray Value Sold to Vendors |cff00ff00NEW!|r", desc = "Show the currency made from selling gray items to vendors.", width = "double", },
                ...
                aboutGroup = { type = "group", order = 100, name = "About",
                    args = {
						...
						generalText49 = { type = "description", order = 50, fontSize = "medium", name = "Discord:", width = "half", },
                        generalText50 = { type = "description", order = 51, fontSize = "medium", name = "https://discord.gg/DNv5wtmzhh", width = "double", },
                        ...
                        generalText100 = { type = "description", order = 100, fontSize = "medium", name = "ACubed10, Brozerian, Conzec89, Goldgoblin, DozerBob, Fatherfajita, GoblinRaset, Hxtasy, JuniorDeBoss, Killerdamage, Morricade, PhatLewts, Selltacular, Skittlezz420", width = "full", },
                    },
                },
            },
        },
